             ...
             <div class="content-item">
                 ...
                 <div class="three-content">
                     <div class="img-content" v-if="content.img">
                       <div class="text-content" v-if="content.content">
                           {{content.content}}
                       </div>
                       <div class="imageList" v-if="content.img">
                          <div v-if="content.img.length === 1">
                              <van-row>
                                <van-col span="24">
                                    <van-image :src="content.img" style="width: 100%;height: 100px;" @click="show = true"></van-image>    
                                </van-col>
                             </van-row>
...
.van-tabs__line{
   background-color:#12C3DF !important;
}
.content{
   background: #ffffff;
   height: 100vh;
